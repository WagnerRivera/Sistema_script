...
////////////////////////////////////////////////////////////////////////
class Script_SIU_SWITCH_Incobech extends Control_Archivos
{
    private $ruta    = "archivos/siu/Siu_";
    private $Archivo = "/Script_SIU_SWITCH_Incobech_";
...
setmoattribute 1 STN=0,Synchronization=0,SynchEthInterface=0 depEthernetInterface STN=0,EthernetInterface='.$array[1][7][33].'
...
setmoattribute 1 STN=0,Synchronization=0,SynchEthInterface=1 depEthernetInterface STN=0,EthernetInterface='.$array[1][7][29].'
...
setmoattribute 1 STN=0,Synchronization=0,SynchEthInterface=2 depEthernetInterface STN=0,EthernetInterface='.$array[1][7][28].'
